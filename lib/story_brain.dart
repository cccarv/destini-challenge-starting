...
//DDNE: Step 17 - Create a method called nextStory(), it should not have any outputs but it should have 1 input called choiceNumber which will be the choice number (int) made by the user.
  void nextStory({int storyNumber}) {
    if (storyNumber == 1 && this._storyNumber == 0) {
      this._storyNumber = 2;
    } else if (storyNumber == 2 && this._storyNumber == 0) {
      this._storyNumber = 1;
    } else if (storyNumber == 1 && this._storyNumber == 1) {
      this._storyNumber = 2;
    } else if (storyNumber == 2 && this._storyNumber == 1) {
      this._storyNumber = 3;
    } else if (storyNumber == 1 && this._storyNumber == 2) {
      this._storyNumber = 5;
    } else if (storyNumber == 2 && this._storyNumber == 2) {
      this._storyNumber = 4;
